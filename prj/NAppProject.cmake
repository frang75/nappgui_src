...
function(nap_project_library libName libPath)
    ...
    if (NOT EXISTS "${libFullPath}")
        ...
        # lib.hdf file
        file(WRITE ${libPathName}.hdf "/* ${libName} library import/export */\n\n")
        file(APPEND ${libPathName}.hdf "#if defined(NAPPGUI_SHARED)\n")
        file(APPEND ${libPathName}.hdf "    #if defined(NAPPGUI_BUILD_${libNameUpper}_LIB)\n")
        file(APPEND ${libPathName}.hdf "        #define NAPPGUI_${libNameUpper}_EXPORT_DLL\n")
        file(APPEND ${libPathName}.hdf "    #else\n")
        file(APPEND ${libPathName}.hdf "        #define NAPPGUI_${libNameUpper}_IMPORT_DLL\n")
        file(APPEND ${libPathName}.hdf "    #endif\n")
        file(APPEND ${libPathName}.hdf "#endif\n")
        file(APPEND ${libPathName}.hdf "\n")
        file(APPEND ${libPathName}.hdf "#if defined(__GNUC__)\n")
        file(APPEND ${libPathName}.hdf "    #if defined(NAPPGUI_${libNameUpper}_EXPORT_DLL)\n")
        file(APPEND ${libPathName}.hdf "        #define _${libName}_api __attribute__((visibility(\"default\")))\n")
        file(APPEND ${libPathName}.hdf "    #else\n")
        file(APPEND ${libPathName}.hdf "        #define _${libName}_api\n")
        file(APPEND ${libPathName}.hdf "    #endif\n")
        file(APPEND ${libPathName}.hdf "#elif defined(_MSC_VER)\n")
        file(APPEND ${libPathName}.hdf "    #if defined(NAPPGUI_${libNameUpper}_IMPORT_DLL)\n")
        file(APPEND ${libPathName}.hdf "        #define _${libName}_api __declspec(dllimport)\n")
        file(APPEND ${libPathName}.hdf "    #elif defined(NAPPGUI_${libNameUpper}_EXPORT_DLL)\n")
        file(APPEND ${libPathName}.hdf "        #define _${libName}_api __declspec(dllexport)\n")
        file(APPEND ${libPathName}.hdf "    #else\n")
        file(APPEND ${libPathName}.hdf "        #define _${libName}_api\n")
        file(APPEND ${libPathName}.hdf "    #endif\n")
        file(APPEND ${libPathName}.hdf "#else\n")
        file(APPEND ${libPathName}.hdf "    #error Unknown compiler\n")
        file(APPEND ${libPathName}.hdf "#endif\n")
        ...
        file(APPEND ${libPathName}.hxx "#include \"${libName}.hdf\"\n")
