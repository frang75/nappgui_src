...
struct Seg2D
{
    _geom2d_api Seg2D() {p0.x = 0, p0.y = 0, p1.x = 0, p1.y = 0;}

    _geom2d_api Seg2D(const real x0, const real y0, const real x1, const real y1) {p0.x = x0, p0.y = y0, p1.x = x1, p1.y = y1;}

    _geom2d_api Seg2D(const V2D<real> *_p0, const V2D<real> *_p1) {p0 = *_p0, p1 = *_p1;}
