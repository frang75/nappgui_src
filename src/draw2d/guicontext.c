...
static const GuiContext *i_CURRENT_CONTEXT = NULL;

GuiContext *gui_context_create(void)
{
    GuiContext *context = heap_new0(GuiContext);
...
void gui_context_destroy(GuiContext **context)
{
    ...
    heap_delete(context, GuiContext);
}
...
{
    cassert_no_null(context);
    ((GuiContext*)context)->retain_count += 1;
    return (GuiContext*)context;
}
...
{
    cassert_no_null(context);
    cassert(context->func_label_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_LABEL] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_LABEL] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_LABEL] == NULL);
    ...
    context->func_label_create = func_label_create;
    context->func_destroy[ekGUI_COMPONENT_LABEL] = func_label_destroy;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_LABEL] = func_attach_label_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_LABEL] = func_detach_label_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_LABEL] = func_label_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_LABEL] = func_label_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_LABEL] = func_label_get_size;
    context->func_get_origin[ekGUI_COMPONENT_LABEL] = func_label_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_LABEL] = func_label_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_button_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_button_OnClick == NULL);
    cassert(context->func_button_set_text == NULL);
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_BUTTON] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_BUTTON] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_BUTTON] == NULL);
    ...
    context->func_button_create = func_button_create;
    context->func_destroy[ekGUI_COMPONENT_BUTTON] = func_button_destroy;
    context->func_button_OnClick = func_button_OnClick;
    context->func_button_set_text = func_button_set_text;
    context->func_set_tooltip[ekGUI_COMPONENT_BUTTON] = func_button_set_tooltip;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_BUTTON] = func_attach_button_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_BUTTON] = func_detach_button_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_BUTTON] = func_button_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_BUTTON] = func_button_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_BUTTON] = func_button_get_size;
    context->func_get_origin[ekGUI_COMPONENT_BUTTON] = func_button_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_BUTTON] = func_button_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_popup_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_popup_OnChange == NULL);
    cassert(context->func_popup_set_elem == NULL);
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_POPUP] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_POPUP] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_POPUP] == NULL);
    ...
    context->func_popup_create = func_popup_create;
    context->func_destroy[ekGUI_COMPONENT_POPUP] = func_popup_destroy;
    context->func_popup_OnChange = func_popup_OnChange;
    context->func_popup_set_elem = func_popup_set_elem;
    context->func_set_tooltip[ekGUI_COMPONENT_POPUP] = func_popup_set_tooltip;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_POPUP] = func_attach_popup_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_POPUP] = func_detach_popup_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_POPUP] = func_popup_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_POPUP] = func_popup_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_POPUP] = func_popup_get_size;
    context->func_get_origin[ekGUI_COMPONENT_POPUP] = func_popup_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_POPUP] = func_popup_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_edit_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_EDITBOX] == NULL);
    ...
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_EDITBOX] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_EDITBOX] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_EDITBOX] == NULL);
    ...
    context->func_edit_create = func_edit_create;
    context->func_destroy[ekGUI_COMPONENT_EDITBOX] = func_edit_destroy;
    ...
    context->func_set_tooltip[ekGUI_COMPONENT_EDITBOX] = func_edit_set_tooltip;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_EDITBOX] = func_attach_edit_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_EDITBOX] = func_detach_edit_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_EDITBOX] = func_edit_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_EDITBOX] = func_edit_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_EDITBOX] = func_edit_get_size;
    context->func_get_origin[ekGUI_COMPONENT_EDITBOX] = func_edit_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_EDITBOX] = func_edit_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_combo_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_COMBOBOX] == NULL);
    ...
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_COMBOBOX] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_COMBOBOX] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_COMBOBOX] == NULL);
    ...
    context->func_combo_create = func_combo_create;
    context->func_destroy[ekGUI_COMPONENT_COMBOBOX] = func_combo_destroy;
    ...
    context->func_set_tooltip[ekGUI_COMPONENT_COMBOBOX] = func_combo_set_tooltip;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_COMBOBOX] = func_attach_combo_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_COMBOBOX] = func_detach_combo_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_COMBOBOX] = func_combo_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_COMBOBOX] = func_combo_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_COMBOBOX] = func_combo_get_size;
    context->func_get_origin[ekGUI_COMPONENT_COMBOBOX] = func_combo_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_COMBOBOX] = func_combo_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_updown_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_updown_OnClick == NULL);
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_UPDOWN] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_UPDOWN] == NULL);
    ...
    context->func_updown_create = func_updown_create;
    context->func_destroy[ekGUI_COMPONENT_UPDOWN] = func_updown_destroy;
    context->func_updown_OnClick = func_updown_OnClick;
    context->func_set_tooltip[ekGUI_COMPONENT_UPDOWN] = func_updown_set_tooltip;
    context->func_attach_to_panel[ekGUI_COMPONENT_UPDOWN] = func_attach_updown_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_UPDOWN] = func_detach_updown_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_UPDOWN] = func_updown_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_UPDOWN] = func_updown_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_UPDOWN] = func_updown_get_size;
    context->func_get_origin[ekGUI_COMPONENT_UPDOWN] = func_updown_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_UPDOWN] = func_updown_set_frame;
} 
...
{
    cassert_no_null(context);
    cassert(context->func_slider_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_slider_OnMoved == NULL);
    cassert(context->func_set_tooltip[ekGUI_COMPONENT_SLIDER] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_SLIDER] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_SLIDER] == NULL);
    ...
    context->func_slider_create = func_slider_create;
    context->func_destroy[ekGUI_COMPONENT_SLIDER] = func_slider_destroy;
    context->func_slider_OnMoved = func_slider_OnMoved;
    context->func_set_tooltip[ekGUI_COMPONENT_SLIDER] = func_slider_set_tooltip;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_SLIDER] = func_attach_slider_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_SLIDER] = func_detach_slider_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_SLIDER] = func_slider_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_SLIDER] = func_slider_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_SLIDER] = func_slider_get_size;
    context->func_get_origin[ekGUI_COMPONENT_SLIDER] = func_slider_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_SLIDER] = func_slider_set_frame;
} 
...
{
    cassert_no_null(context);
    cassert(context->func_progress_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_progress_set_position == NULL);
    cassert(context->func_progress_get_thickness == NULL);
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_PROGRESS] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_PROGRESS] == NULL);
    ...
    context->func_progress_create = func_progress_create; 
    context->func_destroy[ekGUI_COMPONENT_PROGRESS] = func_progress_destroy;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_PROGRESS] = func_attach_progress_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_PROGRESS] = func_detach_progress_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_PROGRESS] = func_progress_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_PROGRESS] = func_progress_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_PROGRESS] = func_progress_get_size; 
    context->func_get_origin[ekGUI_COMPONENT_PROGRESS] = func_progress_get_origin; 
    context->func_set_frame[ekGUI_COMPONENT_PROGRESS] = func_progress_set_frame;
} 
...
{
    cassert_no_null(context);
    cassert(context->func_text_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    ...
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_TEXTVIEW] == NULL);
    ...
    context->func_text_create = func_text_create;
    context->func_destroy[ekGUI_COMPONENT_TEXTVIEW] = func_text_destroy;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_TEXTVIEW] = func_attach_text_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_TEXTVIEW] = func_detach_text_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_TEXTVIEW] = func_text_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_TEXTVIEW] = func_text_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_TEXTVIEW] = func_text_get_size;
    context->func_get_origin[ekGUI_COMPONENT_TEXTVIEW] = func_text_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_TEXTVIEW] = func_text_set_frame;
}
                        ...
                        FPtr_set4_real32 func_split_set_frame)
{
    ...
    cassert(gui_context->func_split_create == NULL);
    ...
    cassert(gui_context->func_set_visible[ekGUI_COMPONENT_SPLITVIEW] == NULL);
    cassert(gui_context->func_set_enabled[ekGUI_COMPONENT_SPLITVIEW] == NULL);
    cassert(gui_context->func_get_size[ekGUI_COMPONENT_SPLITVIEW] == NULL);
    cassert(gui_context->func_get_origin[ekGUI_COMPONENT_SPLITVIEW] == NULL);
    cassert(gui_context->func_set_frame[ekGUI_COMPONENT_SPLITVIEW] == NULL);
    ...
    gui_context->func_split_create = func_split_create;
    ...
    gui_context->func_set_visible[ekGUI_COMPONENT_SPLITVIEW] = func_split_set_visible;
    gui_context->func_set_enabled[ekGUI_COMPONENT_SPLITVIEW] = func_split_set_enabled;
    gui_context->func_get_size[ekGUI_COMPONENT_SPLITVIEW] = func_split_get_size;
    gui_context->func_get_origin[ekGUI_COMPONENT_SPLITVIEW] = func_split_get_origin;
    gui_context->func_set_frame[ekGUI_COMPONENT_SPLITVIEW] = func_split_set_frame;
}
...
{
    cassert_no_null(context);
    cassert(context->func_view_create == NULL);
    cassert(context->func_destroy[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    ...
    cassert(context->func_destroy[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_attach_to_panel[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_CUSTOMVIEW] == NULL);
    ...
    context->func_view_create = func_view_create;
    context->func_destroy[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_destroy;
    ...
    context->func_attach_to_panel[ekGUI_COMPONENT_CUSTOMVIEW] = func_attach_view_to_panel;
    context->func_detach_from_panel[ekGUI_COMPONENT_CUSTOMVIEW] = func_detach_view_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_get_size;
    context->func_get_origin[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_CUSTOMVIEW] = func_view_set_frame;
}
                        ...
                        FPtr_set4_real32 func_panel_set_frame)
{
    ...
    cassert(context->func_detach_from_panel[ekGUI_COMPONENT_PANEL] == NULL);
    cassert(context->func_set_visible[ekGUI_COMPONENT_PANEL] == NULL);
    cassert(context->func_set_enabled[ekGUI_COMPONENT_PANEL] == NULL);
    cassert(context->func_get_size[ekGUI_COMPONENT_PANEL] == NULL);
    cassert(context->func_get_origin[ekGUI_COMPONENT_PANEL] == NULL);
    cassert(context->func_set_frame[ekGUI_COMPONENT_PANEL] == NULL);
    ...
    context->func_detach_from_panel[ekGUI_COMPONENT_PANEL] = func_detach_panel_from_panel;
    context->func_set_visible[ekGUI_COMPONENT_PANEL] = func_panel_set_visible;
    context->func_set_enabled[ekGUI_COMPONENT_PANEL] = func_panel_set_enabled;
    context->func_get_size[ekGUI_COMPONENT_PANEL] = func_panel_get_size;
    context->func_get_origin[ekGUI_COMPONENT_PANEL] = func_panel_get_origin;
    context->func_set_frame[ekGUI_COMPONENT_PANEL] = func_panel_set_frame;
}
